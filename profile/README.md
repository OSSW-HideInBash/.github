...
![image](https://github.com/user-attachments/assets/9e4c5e03-727d-4fa4-b0dd-6d096ad0ed05)
...
| 이름 | 역할 | 주요 담당 |
|------|------|-----------|
| **권용빈** | PM & 디자인 | 서비스 구조 설계, 애니메이션 서버 개발, UI/UX |
| **김재경** | 백엔드 | Flask 서버, DB, 애니메이션 호출 로직 |
| **이우신** | 프론트엔드 | 앱 내 상호작용 구현, 애니메이션 연동 |
| **이우진** | 프론트+서버 | 안드로이드 개발, 캐릭터 생성, 서버 연동 |
